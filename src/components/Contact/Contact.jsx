export const Contact = () => {
  return (
    <div id="contact-us" className="container mx-auto pt-16">
      <div className="lg:flex">
        <div className="xl:w-2/5 lg:w-2/5 bg-cyan-600 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
          <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
            ...
            <p className="text-xl text-white pb-8 leading-relaxed font-normal lg:pr-4">
              আমাদের সম্পর্কে কোনো প্রশ্ন আছে? আপনি কি আমাদের সাথে যোগদানের
              বিষয়ে আগ্রহী? কোনো পরামর্শ দিতে চান অথবা শুধু হ্যালো বলতে চান?
              শুধু আমাদের সাথে যোগাযোগ করুন। আমরা আপনাকে সহায়তা করার জন্য এখানে
              আছি।
            </p>
            <div className="flex pb-4 items-center">
              ...
              <p className="pl-4 text-white text-base">+880 (308) 321 321</p>
            </div>
            <div className="flex items-center">
              ...
              <p className="pl-4 text-white text-base">admin@sasthoseba.com</p>
            </div>
            <p className="text-lg text-white pt-10 tracking-wide">
           মিরপুর-১২, শেরাপাড়া, ঢাকা
            </p>
        ...
        <div className="xl:w-3/5 lg:w-3/5 bg-gray-200 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
          ...
          >
            ...
            <div className="w-full mt-6">
              ...
              <button
                type="submit"
                className="focus:outline-none bg-cyan-600 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-8 py-3 text-sm leading-6"
              >
                Submit
              </button>
            </div>
